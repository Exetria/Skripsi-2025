...
part 'check_user_data_domain.freezed.dart';
part 'check_user_data_domain.g.dart';

@freezed
class CheckUserDataDomain with _$CheckUserDataDomain {
  const factory CheckUserDataDomain({
    @JsonKey(name: 'name') String? name,
    @JsonKey(name: 'fields') Fields? fields,
    @JsonKey(name: 'createTime') String? createTime,
    @JsonKey(name: 'updateTime') String? updateTime,
  }) = _CheckUserDataDomain;

  factory CheckUserDataDomain.fromJson(Map<String, dynamic> json) =>
      _$CheckUserDataDomainFromJson(json);
}
